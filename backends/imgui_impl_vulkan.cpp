...
static void ImGui_ImplVulkan_RenderWindow(ImGuiViewport* viewport, void*)
{
    ...
    {
        {
            err = vkAcquireNextImageKHR(v->Device, wd->Swapchain, UINT64_MAX, wd->FrameSemaphores[wd->SemaphoreIndex].ImageAcquiredSemaphore, VK_NULL_HANDLE, &wd->FrameIndex);
...

    {
        ...
        }
        {
            ...
            info.pWaitSemaphores = &wd->FrameSemaphores[wd->SemaphoreIndex].ImageAcquiredSemaphore;
...
static void ImGui_ImplVulkan_SwapBuffers(ImGuiViewport* viewport, void*)
{
    ...
    info.waitSemaphoreCount = 1;
    info.pWaitSemaphores = &wd->FrameSemaphores[present_index].RenderCompleteSemaphore;
